...
export default function Dashboard(props) {
    ...
    return (
        <Authenticated
            auth={props.auth}
            errors={props.errors}
            header={<h2 className="font-semibold text-xl text-gray-800 leading-tight">Builds</h2>}
        >
            <Head title="Builds" />
                    ...
                    <div className="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                        <div className="p-6 bg-white border-b border-gray-200">
                            ...
                            <table className="table-fixed w-full">
                                ...
                                <tbody>
                                {builds.map(({ id, character, element, talents, weapons, artifacts, teams}) => (
                                    <tr>
                                        <td className="border px-4 py-2">{ id }</td>
                                        <td className="border px-4 py-2">{ character }</td>
                                        <td className="border px-4 py-2">{ element }</td>
                                        <td className="border px-4 py-2">{ talents }</td>
